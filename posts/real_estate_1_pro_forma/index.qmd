...
I will use two different methods for generating random scenarios for the project. The first is the `sample()` function, which lets me sample outcomes from a discrete set of outcomes and weights. The second is the `rbeta()` function, which lets me generate random deviates of custom [beta distributions](https://en.wikipedia.org/wiki/Beta_distribution). 
...
Some great refreshers of random distributions in R can be found: 
*  [here](https://rstudio-pubs-static.s3.amazonaws.com/100906_8e3a32dd11c14b839468db756cee7400.html) and
*  [here](https://www.huber.embl.de/users/kaspar/biostat_2021/2-demo.html) and
